XOP.NET - Release 0.01 - 11 Dec 2009


This is a barebones Visual Studio 2008 solution for an 
Igor Pro XOP that calls C# (.NET) code in a separate library.

It was tested on Igor 5, and should work on Igor 6 also.
...
standard library search behavior, as listed here 
...
in the XOP Toolkit.  The modifications, and the new code here (DllResolver.cpp)
are provided under the open source BSD license 
